    ...
    if (currentState === 'signUp') {
      if (validateForm()) {
        try {
          ...
          const response = await fetch('https://server-19qv.onrender.com/api/v1/admin-register', {
            method: 'POST',
            headers: {
      ...
      try {
        ...
        const response = await fetch('https://server-19qv.onrender.com/api/v1/admin-login', {
          headers: {
            'Content-Type': 'application/json',
          },
          method: 'POST',
