...
console.log("od", orderItems);
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://server-19qv.onrender.com/api/zing/createOrder", options,
      );
      const data = res.data;
      ...
      const paymentObject = new window.Razorpay({
        ...
        handler: async function (response) {
          ...
          const res = await axios.post("https://server-19qv.onrender.com/api/zing/verifyOrder",options2,
            {
              headers: {
